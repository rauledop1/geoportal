export const IconPolygon = () => (
    <svg viewBox="0 0 256 256" id="Flat" xmlns="http://www.w3.org/2000/svg" fill="#FFFFFF">
        ...
        <g id="SVGRepo_iconCarrier">
            <path d="M137,65A24,24,0,1,1,137,31,24,24,0,0,1,137,65ZM23,103A24,24,0,1,0,57,103,24,24,0,0,0,23,103Zm120,88A24,24,0,1,0,177,191,24,24,0,0,0,143,191ZM225,55A24,24,0,1,0,225,89,24,24,0,0,0,225,55Z" opacity="0.2" fill="none" />
...
export const IconMagnet = () => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round">
        <path d="M6 21V9a9 9 0 0 0 9 9 9 9 0 0 0 9-9v12" />
        <path d="M6 8V6a5 5 0 0 1 5-5h2a5 5 0 0 1 5 5v2" />
    </svg>
);
